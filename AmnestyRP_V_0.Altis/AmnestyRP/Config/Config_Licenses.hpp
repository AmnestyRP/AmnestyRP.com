...
class Licenses {
	...
	class rebel4 {
        variable = "rebel4";
        displayName = "STR_Rebel_Sergeant";
        price = 75000;
        illegal = false;
        side = "civ";
    };
	...
	class rebel5 {
        variable = "rebel5";
        displayName = "STR_Rebel_Lieutenant";
        price = 75000;
        illegal = false;
        side = "civ";
    };
