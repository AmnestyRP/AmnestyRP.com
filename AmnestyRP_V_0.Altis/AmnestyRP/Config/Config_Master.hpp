...
/* System Settings */
    ...
    respawn_timer = 150; //How many seconds a player should wait, before being able to respawn. Minimum 5 seconds.
    ...
    fuel_cost = 14; //Cost of fuel per liter at fuel stations (if not defined for the vehicle already).
    ...
    vehicle_purchase_multiplier_MEDIC = .9; //Medic Vehicle Buy Price = Config_Vehicle price * multiplier
